...
class compas:
    """
    A new class that replicates the data from the original './config.py' compas
    class but uses '@property' for getters and setters.
    """
...
class heart:
    """
    A new class that replicates the data from the original './config.py' heart
    class but uses '@property' for getters and setters.
    """
...
class default:
    """
    A new class that replicates the data from the original './config.py' default
    class but uses '@property' for getters and setters.
    """
...
class lawschool:
    """
    A new class that replicates the data from the original './config.py' lawschool
    class but uses '@property' for getters and setters.
    """
    def __init__(self):
        # The size of total features
