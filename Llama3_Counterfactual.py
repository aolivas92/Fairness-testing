...
# Sex: Female, Wife
messages += [{'role': 'user', 'content': "I am a 35-year-old Female, working in the private sector, with a capital gain of \
...
# Sex: Female, Wife
# messages += [{'role': 'user', 'content': "I am a 45-year-old Female, employed in local government, with a capital gain of \
...
# Sex: Male, Husband
# messages += [{'role': 'user', 'content': "I am a 50-year-old Male, self-employed (not incorporated), with a capital gain \
...
# Sex: Male, Husband
# messages += [{'role': 'user', 'content': "I am a 40-year-old Male, working in the federal government, with no capital gain \
